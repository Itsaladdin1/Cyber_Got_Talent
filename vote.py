...
def candidates():
    ...
    username = session.get('username')
    return render_template('view.html', candidates=candidates, username=username)
...
def admin_panel():
    ...
    return render_template('admin.html', candidates=candidates, username=username)
...
def results():
    votes = get_votes()
    username = session.get('username')
    return render_template('results.html', results=results, username=username,  votes=votes)
